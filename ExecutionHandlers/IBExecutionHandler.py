...
from ext.Contract import Contract
from ext.Order import Order
from opt import ibConnection

from Events.FillEvent import FillEvent
from ExecutionHandlers import IExecutionHandler


class IBExecutionHandler(IExecutionHandler):
    """
